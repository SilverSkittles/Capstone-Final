...
namespace SeedShare.Views
{
    ...
    {        
        ...
        protected override async void OnAppearing()
        {
            ...
            var vm = (SeedsViewModel)BindingContext;
            await vm.Refresh();
        }
        ...
        private async void SeedSearch_TextChanged(object sender, TextChangedEventArgs e)
        {
            var vm = (SeedsViewModel)BindingContext;
            await vm.FilterItems(e.NewTextValue);
        }

        private async void seedPDF_Clicked(object sender, EventArgs e)
        {
            try
            {
                var vm = (SeedsViewModel)BindingContext;
                // Column fields on report
                var list = vm.Seeds.Select(l => new { l.seedName, l.packetQuantity, l.location }).ToList();
                ...
                PdfTextElement element = new PdfTextElement("Seed List " + DateTime.Now.ToLongDateString(), subHeadingFont);
                ...
                element = new PdfTextElement("Seed List " + DateTime.Now.ToString(), timesRoman);
